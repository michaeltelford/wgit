...
class TestDocument < TestHelper
  ...
  def test_internal_links
    ...
    doc = Wgit::Document.new "http://www.mytestsite.com/home".to_url,
                             "<p>Hello World!</p>"
  ...
  def test_double_equals
    ...
    refute doc == Wgit::Document.new(
      Wgit::Url.new("http://www.mytestsite.com/index"), @html
    )
    refute doc == Wgit::Document.new("http://www.mytestsite.com".to_url,
                                     "#{@html}<?php echo 'Hello' ?>")
  end
  ...
  def test_base_url__no_base
    ...
    assert_equal "Document @url ('/home') cannot be relative if <base> is nil",
                 ex.message
  end
  ...
  def test_base_url__relative_base
    ...
    assert_equal "Document @url ('/home') and <base> ('/public') both can't be relative",
                 ex.message
  end
