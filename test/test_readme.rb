...
class TestReadme < TestHelper
  ...
  def test_quotes__classes
    ...
    Wgit::Document.define_extractor(:quotes,
                                    "//div[@class='quote']/span[@class='text']", singleton: false)
    Wgit::Document.define_extractor(:authors,
                                    "//div[@class='quote']/span/small",          singleton: false)
