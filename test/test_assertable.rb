...
class TestAssertable < TestHelper
  ...
  def test_assert_arr_types__pass
    assert_equal [1, true, "Boom!"],
                 assert_arr_types([1, true, "Boom!"], [Integer, TrueClass, String])
    assert_equal [1, true, "/about"],
                 assert_arr_types([1, true, "/about".to_url],
                                  [Integer, TrueClass, String])
  end
